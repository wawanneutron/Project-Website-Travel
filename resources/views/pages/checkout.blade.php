      ...
      <div class="container">
          <div class="row ml-1">
              <div class="col p-0">
                  <nav>
                      <ol class="breadcrumb">
                      <li class="breadcrumb-item"> <a href="{{ route('home') }}">Paket Travel</a>
                          </li>
                          <li class="breadcrumb-item"> <a href="{{ route('details') }}">Details</a>
          ...
          <div class="row">
              <div class="col-lg-8 pl-lg-0">
                  <div class="card card-details">
                      <h1>Who's Going?</h1>
                      <p>Rinjani Lombok Island, Indonesian</p>
                      <div class="who-is-going">
                          <table class="table table-responsive-sm text-center">
                              ...
                              <tbody>
                                  <tr>
                                      <td>
                                          <img src="{{ url('frontend/images/checkout/1.png') }}" class="rounded-circle"
                                              height="60" alt="">
                                      </td>
                                  ...
                                  <tr>
                                      <td>
                                          <img src="{{ url('frontend/images/checkout/2.png') }}" class="rounded-circle"
                                              height="60" alt="">
                                      </td>
                                      <td class="align-middle">
                                          Mr.Hutbel
                                  ...
                                  <tr>
                                      <td>
                                          <img src="{{ url('frontend/images/checkout/3.png') }}" height="60"
                                              class="rounded-circle" alt="">
                                      </td>
                                      <td class="align-middle">Neutron</td>
                                      <td class="align-middle">
                                          Malaysia
                                      </td>
                                      <td class="align-middle">
                      ...
                      <div class="member mt-3">
                          ...
                          <form action="" class="form-inline">
                              ...
                              <input type="text" class="form-control mb-2 mt-2 mr-2 " id="inputUsername"
                              ...
                              <button type="submit" class="btn btn-add-now mb-2 px-4 mt-2">
                                  Add Now
                              </button>
                          </form>
              ...
              <div class="col-lg-4">
                  ...
                  <div class="join-container">
                      <a href="{{ route('checkout-succses') }}" class="btn btn-block btn-join-now mt-3 py-2">I Have Made Payment</a>
                  </div>
                  <div class="text-center mt-3">
                      <a href="{{ route('home') }}" class="text-muted mt-3 py-2">Cancle
                          Booking</a>
                  </div>
              </div>
          </div>
